...
class FincallLog(Document):
    def after_insert(self):
        self.bg_employee_log_generation()

    def bg_employee_log_generation(self):
    ...
    def enqueue_logs(self,call_logs):
    ...
    def create_employee_log(self,fincall_log):
        try:
            ...
            frappe.log_error(message=str(e), title="Employee Log Creation Failed")
