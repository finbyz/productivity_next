			...
			<div class="row mt-3">
				<div class="col-md-4">
					<div class="frappe-card  custom-card">
						...
						<div class="number custom-number" style="font-size: 18px !important; color: #00A6E0 !important;">${this.convertSecondsToTime(data.total_hours + data.total_idle_time)}</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="frappe-card  custom-card">
